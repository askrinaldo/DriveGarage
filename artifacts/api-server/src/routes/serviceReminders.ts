...
router.get("/vehicles/:vehicleId/reminders", async (req, res): Promise<void> => {
  ...
  // Get vehicle mileage for status calculation
...
// ─── Create reminder ──────────────────────────────────────────────────────────
router.post("/vehicles/:vehicleId/reminders", async (req, res): Promise<void> => {
  const vehicleId = parseInt(String(req.params.vehicleId), 10);
...
// ─── Update reminder ──────────────────────────────────────────────────────────
router.patch("/vehicles/:vehicleId/reminders/:reminderId", async (req, res): Promise<void> => {
  const vehicleId = parseInt(String(req.params.vehicleId), 10);
...
router.post("/vehicles/:vehicleId/reminders/:reminderId/complete", async (req, res): Promise<void> => {
  const vehicleId = parseInt(String(req.params.vehicleId), 10);
  const reminderId = parseInt(String(req.params.reminderId), 10);
...
// ─── Delete reminder ──────────────────────────────────────────────────────────
router.delete("/vehicles/:vehicleId/reminders/:reminderId", async (req, res): Promise<void> => {
  const vehicleId = parseInt(String(req.params.vehicleId), 10);
  const reminderId = parseInt(String(req.params.reminderId), 10);
