...
export default function PrivacyPage() {
  return (
    <LegalPageShell title="Personvernerklæring" lastUpdated="[Dato settes ved lansering]" showDraftBanner>
      ...
      <LegalSection title="2. Dataansvarlig">
        ...
        <div className="rounded-md border border-white/[0.08] bg-white/[0.04] p-4 text-sm font-mono space-y-1">
      ...
      <LegalSection title="8. Klagerett til Datatilsynet">
        ...
        <div className="rounded-md border border-white/[0.08] bg-white/[0.04] p-4 text-sm">
