  ...
  return (
    ...
    >
      ...
      <LegalSection title="2. Vår bruk: kun nødvendig lagring">
        <p>
          <strong className="text-white">DriveGarage bruker ingen sporings-, analyse- eller
        ...
        <div className="space-y-4">
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">Clerk-autentiseringskapsler</p>
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">sidebar_state (informasjonskapsel)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">dg-theme (localStorage)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">i18nextLng (localStorage)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">club-session-* (localStorage)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">dg-ai-chat-history (sessionStorage)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
          ...
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <div className="flex items-center justify-between mb-2">
              <p className="font-medium text-white text-sm">dg-cookie-notice-v1 (localStorage)</p>
              <span className="text-xs bg-indigo-500/20 text-indigo-300 px-2 py-0.5 rounded-full">Nødvendig</span>
            </div>
            <p className="text-xs text-[#8899bb]">
      ...
      <LegalSection title="4. Tredjeparters lagring">
        <div className="space-y-3">
          <div className="rounded-md border border-white/10 bg-white/[0.02] p-4">
            <p className="font-medium text-white text-sm mb-1">Clerk Inc. — Autentisering</p>
            <p className="text-xs text-[#8899bb]">
      ...
      <LegalSection title="5. Dine valg">
        ...
        <p>
          ...
          <a href="mailto:kontakt@drivegarage.no" className="underline hover:text-white">kontakt@drivegarage.no</a>.
        </p>
      </LegalSection>
