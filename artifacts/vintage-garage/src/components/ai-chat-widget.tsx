...
const WELCOME: Message = {
  role: "assistant",
  content: "Hei! Jeg er DriveGarage-assistenten 🔧 Jeg kan hjelpe deg med kjøretøy, servicelogg, klubber og mer. Hva lurer du på?",
};
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-sidebar">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">AI-hjelp for DriveGarage</p>
              </div>
            </div>
