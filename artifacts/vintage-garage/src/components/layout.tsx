      ...
      <div className="px-5 pt-6 pb-4">
        <Link href="/dashboard">
          <div className="flex items-center gap-3 cursor-pointer group">
            ...
            <span className="font-black text-lg tracking-tight text-sidebar-foreground">VintageGarage</span>
          </div>
        </Link>
      </div>
      ...
      <main className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="md:hidden flex items-center justify-between px-4 py-3 sticky top-0 z-30 bg-sidebar/90 backdrop-blur-md border-b border-sidebar-border">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-black text-base text-sidebar-foreground tracking-tight">VintageGarage</span>
          </div>
